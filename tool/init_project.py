...
if __name__ == '__main__':                                                                 
    # 修改成要执行的测试用例
    test_case = 'test_case/test_run.py'
...
def test_recharge(data):
    feature = "acc"  # 功能
    story = 'recharge'  # 故事
    title = "充值"  # 标题
    method = POST
    url = "/acc/recharge"  # 接口地址
...
from tools.yaml_tools import read_yaml
...
def get_datas(dir_path):
    ...
    if(os.path.isdir(dir_path)):
        ...
        print("请检查data文件的路径是否正确:" + dir_path)
    return ids,datas
...
os_tool.mkfile(root_path,*['./', 'tools', '__init__.py'], content=content)
        ...
        """
os_tool.mkfile(root_path,*['./', 'tools', 'init_project.py'], content=content)
